...
const Men = () => {
    ...
    const watches = [
        { id: 1, watchImage: "/Images/1.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 2, watchImage: "/Images/2.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 3, watchImage: "/Images/3.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 4, watchImage: "/Images/4.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 5, watchImage: "/Images/5.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 6, watchImage: "/Images/19.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 7, watchImage: "/Images/7.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 8, watchImage: "/Images/8.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 9, watchImage: "/Images/9.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 19, watchImage: "/Images/10.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 11, watchImage: "/Images/11.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 12, watchImage: "/Images/22.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 13, watchImage: "/Images/13.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 14, watchImage: "/Images/14.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 15, watchImage: "/Images/15.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 16, watchImage: "/Images/16.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 17, watchImage: "/Images/17.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
        { id: 18, watchImage: "/Images/18.webp", watchName: "Aspire", discription: "Men's Leather Watch", price: "1200$", section: "men" },
    ];
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6 mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-stretch rounded-full border border-white/15 overflow-hidden">
                                <button
                                    onClick={dec}
                                    className="px-3 py-2 text-white/90 hover:bg-white/10 disabled:opacity-40 cursor-pointer"
